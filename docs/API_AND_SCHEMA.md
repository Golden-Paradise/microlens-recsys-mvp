...
| `GET /api/admin/dashboard` | 管理员 | 概览、流占比、热门内容 |
| `GET /api/admin/feeds/diagnostics` | 管理员 | 各 Feed 请求/曝光/点击/CTR |
...
典型错误：未登录 401、普通用户访问管理接口 403、曝光不属于当前用户 404、重复 event_id 的不同 payload 409、强推离线内容 409、无效时间窗 422。
